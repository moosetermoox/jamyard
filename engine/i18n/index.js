...
export const STRINGS = {
  es: {
    ...
    'Start the next round': 'Empezar la siguiente ronda',
    'Play the video': 'Reproducir el video',
    'Show the picture': 'Mostrar la imagen',
    'Finish up': 'Terminar',
    'Continue': 'Continuar',
    ...
    "You're done!": '¡Listo, terminaste!',
    'Thanks, that is all we need from you. You can put your device away.': 'Gracias, eso es todo lo que necesitamos de ti. Ya puedes guardar tu dispositivo.',
    'in the room': 'en la sala',
    'Start the quiz': 'Empezar el cuestionario',
    'End the quiz': 'Terminar el cuestionario',
    'Question': 'Pregunta',
    'of': 'de',
    'Correct!': '¡Correcto!',
    'Not quite.': 'No exactamente.',
    'The answer was': 'La respuesta era',
  ...
  fr: {
    ...
    'Start the next round': 'Lancer la manche suivante',
    'Play the video': 'Lancer la vidéo',
    'Show the picture': "Afficher l'image",
    'Finish up': 'Terminer',
    'Continue': 'Continuer',
    ...
    "You're done!": 'Tu as terminé !',
    'Thanks, that is all we need from you. You can put your device away.': "Merci, c'est tout ce qu'il nous faut. Tu peux ranger ton appareil.",
    'in the room': 'dans la salle',
    'Start the quiz': 'Lancer le quiz',
    'End the quiz': 'Terminer le quiz',
    'Question': 'Question',
    'of': 'sur',
    'Correct!': 'Correct !',
  ...
  de: {
    ...
    'Reveal the answer': 'Antwort aufdecken',
    'Start the next round': 'Nächste Runde starten',
    'Play the video': 'Video abspielen',
    'Show the picture': 'Bild anzeigen',
    ...
    "You're done!": 'Fertig!',
    'Thanks, that is all we need from you. You can put your device away.': 'Danke, mehr brauchen wir nicht von dir. Du kannst dein Gerät weglegen.',
    'in the room': 'im Raum',
    'Start the quiz': 'Quiz starten',
    'End the quiz': 'Quiz beenden',
    'Question': 'Frage',
    'of': 'von',
    'Correct!': 'Richtig!',
    'Not quite.': 'Nicht ganz.',
    'The answer was': 'Die richtige Antwort war',
  ...
  pt: {
    ...
    'Start the next round': 'Começar a próxima rodada',
    'Play the video': 'Reproduzir o vídeo',
    'Show the picture': 'Mostrar a imagem',
    'Finish up': 'Terminar',
    'Continue': 'Continuar',
    ...
    "You're done!": 'Você terminou!',
    'Thanks, that is all we need from you. You can put your device away.': 'Obrigado, é só isso que precisamos de você. Pode guardar seu dispositivo.',
    'in the room': 'na sala',
    'Start the quiz': 'Começar o quiz',
    'End the quiz': 'Encerrar o quiz',
    'Question': 'Pergunta',
    'of': 'de',
    'Correct!': 'Correto!',
    'Not quite.': 'Não exatamente.',
    'The answer was': 'A resposta certa era',
  ...
  it: {
    ...
    'Start the next round': 'Inizia il prossimo turno',
    'Play the video': 'Riproduci il video',
    'Show the picture': "Mostra l'immagine",
    'Finish up': 'Concludi',
    'Continue': 'Continua',
    ...
    'Thanks, that is all we need from you. You can put your device away.': 'Grazie, non ci serve altro da te. Puoi mettere via il dispositivo.',
    'in the room': 'nella stanza',
    'Start the quiz': 'Inizia il quiz',
    'End the quiz': 'Termina il quiz',
    'Question': 'Domanda',
    'of': 'di',
    'Correct!': 'Corretto!',
    'Not quite.': 'Non proprio.',
    'The answer was': 'La risposta giusta era',
