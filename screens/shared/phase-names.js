...
window.PHASE_BLURBS = {
  ...
  'assign': 'After a ranking, every group (or student) is handed one of the items: first choices first, spread evenly.',
  ...
  'who-rounds': 'A round per answer: it goes up, everyone picks who wrote it from a short list, then the author is revealed.',
