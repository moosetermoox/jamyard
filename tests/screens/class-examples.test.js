...
const FEATURED = ['art-gallery', 'both-sides-rope', 'class-critique', 'closer', 'doodle-bluff', 'exit-ticket', 'group-work-day', 'live-poll', 'one-more-thing', 'snowball', 'solo-quiz', 'someones-got-you', 'trivia-bluff', 'vocab-match', 'whose-eyes'];
