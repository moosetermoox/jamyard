...
- rank: the whole class drags a list into order and the class's combined order goes up on the projector afterward. text = the ranking instruction ("Scariest first"). Ranks the answers from the most recent collect step; or give items = 2-12 strings for a list you write yourself. timer optional. Use this whenever students order, rank, or sort answers by a criterion; a vote picks ONE favorite, it does not rank.
