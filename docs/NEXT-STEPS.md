...
Left for the owner from the audit (a design call, not a one-liner): white text on the brand red `#E5482B` (3.8:1), cyan `#1BA9C4` (2.7:1) and green `#22A05A` (3.2:1) fails 4.5:1 on buttons, plank tops, and chips; red link text on gesso too. Darker paints that pass: red #C93A1F, cyan #0E7F96, green #1A7F46; or ink-colored text on those buttons. Either changes the look.
